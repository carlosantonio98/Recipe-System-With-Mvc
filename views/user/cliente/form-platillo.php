...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="mb-4">
        <div class="container">
            ...
            <?php if($_GET['page'] == 'form-create-platillo-cliente'): ?>
            ...
            <form action="controllers/controller.platillo.php" method="POST"enctype="multipart/form-data" accept=".png, .jpeg, .jpg">
                ...
                <div class="form-group">
                    <a href=<?= ($_GET['page'] == 'form-create-platillo-cliente') ? "?page=menu-cliente":"?page=platillo-cliente&id=$id" ?> class="btn btn-primary">Regresar</a>
                    <button type="submit" class="btn btn-success"><?= ($_GET['page'] == 'form-create-platillo-cliente') ? 'Crear platillo':'Guardar cambios' ?></button>
                </div>
            </form>
        </div>
    </main>
